    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/slimgremlin/corntico/")
                ...
                developers {
                    developer {
                        id.set("slimgremlin")
                        name.set("slimgremlin")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/slimgremlin/corntico.git")
                    developerConnection.set("scm:git:ssh://github.com/slimgremlin/corntico.git")
                    url.set("https://github.com/slimgremlin/corntico/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/slimgremlin/corntico/issues")
                }
            }
        }
    }
