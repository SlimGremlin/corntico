...
![Build](https://github.com/SlimGremlin/corntico/workflows/Pre%20Merge%20Checks/badge.svg)
...
- [ ] Choose a [LICENSE](https://github.com/SlimGremlin/corntico/community/license/new?branch=main).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/SlimGremlin/corntico/settings/secrets/actions).
